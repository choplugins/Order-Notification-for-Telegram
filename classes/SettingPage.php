...
class SettingPage extends \WC_Settings_Page
{
    ...
    {
        $token_help = wp_kses(__("Just talk to BotFather <a href='https://telegram.im/BotFather' target='_blank'>@BotFather</a> and text <code>/start</code>, then <code>/newbot</code>, finally <code>YourNameBot</code> (Note: your bot name must end with Bot, ex: ChoPluginBot). Once you've created a bot and received your authorization token.", 'nk-custom-pc-builder'), array('a' => ['href' => 'https://telegram.im/BotFather','target' =>'_blank'], 'code' => []));
